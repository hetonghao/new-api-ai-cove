 ...
 * Mirrors the backend isResponsesWebSocketChannelType allow list (OpenAI,
 * xAI, Codex, Advanced Custom, Sub2API, New API); the per-channel toggle
 * still decides whether a channel is actually used.
 */
