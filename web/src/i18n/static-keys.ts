...
export const STATIC_I18N_KEYS = [
  ...
  'Shown',
  'Not shown',
  // Model quality sample/run status and error labels.
  'Pending',
  'Requesting',
  'Succeeded',
  'Cancelled',
  ...
  'Upstream error',
  'Empty output',
  'Response ended without a terminal event',
  'SVG output too large',
  'SVG rejected by safety checks',
  'Artifact exceeds the size limit',
  'Invalid configuration',
  'Interrupted; result unknown',
  'Execution token is not approved',
  'Daily budget exhausted',
  'Not annotated',
  'Acceptable',
  'Subject missing',
  'Riding relation wrong',
  'Bicycle structure abnormal',
  'Seaside missing',
  'Possibly blank',
  'Needs review',
  ...
  'Stream event could not be parsed',
  'Upstream reported a stream error',
  'Stream sent more than one terminal event',
  'Content arrived after the terminal event',
  'Stream interrupted before completion',
  'Failed to read the upstream response',
  'Output text exceeds the 2 MiB limit',
  'Upstream stream exceeds the 64 MiB limit',
  'A stream event exceeds the 8 MiB limit',
