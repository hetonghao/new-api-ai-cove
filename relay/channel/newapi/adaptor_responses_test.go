...
func TestConvertOpenAIResponsesRequestNormalizesInterleavedToolOutputsForDeepSeek(t *testing.T) {
...
func TestConvertOpenAIResponsesRequestLeavesNonDeepSeekInput(t *testing.T) {
	req := dto.OpenAIResponsesRequest{
		Model: "gpt-5.6-sol",
		Input: mustJSON(t, []map[string]any{
			{"type": "function_call", "call_id": "call-1", "name": "exec_command", "arguments": "{}"},
