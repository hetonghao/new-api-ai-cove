...
func GetRandomSatisfiedChannel(
	...
	return getRandomSatisfiedChannelWithSelection(group, model, retry, false, nil, filters)
}

func GetRandomSatisfiedChannelWithSelection(group string, model string, retry int, requestPath string, requireWebSockets bool, excludedChannelIDs map[int]bool, filters ...[]dto.ChannelFilter) (*Channel, error) {
	...
	return getRandomSatisfiedChannelWithSelection(group, model, retry, requireWebSockets, excludedChannelIDs, channelFilters)
}

func getRandomSatisfiedChannelWithSelection(group string, model string, retry int, requireWebSockets bool, excludedChannelIDs map[int]bool, filters []dto.ChannelFilter) (*Channel, error) {
	// if memory cache is disabled, get channel directly from database
	if !common.MemoryCacheEnabled {
		return GetChannelWithSelection(group, model, retry, "", requireWebSockets, excludedChannelIDs, filters)
	}
