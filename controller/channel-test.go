...
func normalizeChannelTestEndpoint(channel *model.Channel, endpointType string, automatic bool) string {
...
func testChannel(ctx context.Context, channel *model.Channel, testUserID int, testModel string, endpointType string, isStream bool, automatic bool) testResult {
	if ctx == nil {
	...
	endpointType = normalizeChannelTestEndpoint(channel, endpointType, automatic)
	...
	if endpointType != "" {
		...
		case constant.EndpointTypeAnthropic:
			return &dto.ClaudeRequest{
				Model:     model,
				Stream:    lo.ToPtr(isStream),
				MaxTokens: lo.ToPtr(channelTestMaxOutputTokens(16, automatic)),
		...
		case constant.EndpointTypeGemini:
			return &dto.GeminiChatRequest{
				...
				GenerationConfig: dto.GeminiChatGenerationConfig{
					MaxOutputTokens: lo.ToPtr(channelTestMaxOutputTokens(3000, automatic)),
				},
			}
		case constant.EndpointTypeOpenAI:
